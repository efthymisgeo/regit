...
#SBATCH --job-name=drop5-small    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/drop5-small.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/drop5-small.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
-e configs/experiment/aris/drop5_cifar10.json