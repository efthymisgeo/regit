...
#SBATCH --job-name=mul-s-6-smp-0.1    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/mul-s-6-smp-0.1.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/mul-s-6-smp-0.1.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
-e configs/experiment/aris/mul_6_smp_0.1.json