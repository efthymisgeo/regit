...
#SBATCH --job-name=drop2-small    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/drop2-small.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/drop2-small.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
-e configs/experiment/aris/drop2_cifar10.json