...
#SBATCH --job-name=lin15-20-na-0.0001    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/lin15-20-na-0.0001.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/lin15-20-na-0.0001.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
#SBATCH --time=48:00:00   # HH:MM:SS Estimated time the job will take. It will be killed if it exceeds the time limit
...
-e configs/experiment/aris/lin_15_20_na_0.0001.json