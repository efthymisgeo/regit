...
#SBATCH --job-name=mul-s-16    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/mul-s-16.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/mul-s-16.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
-e configs/experiment/aris/mul_16.json