...
#SBATCH --job-name=mul-s-40    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/mul-s-40.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/mul-s-40.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
-e configs/experiment/aris/mul_40.json