...
#SBATCH --job-name=lin15-30-na-0.01    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/lin15-30-na-0.01.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/lin15-30-na-0.01.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
-e configs/experiment/aris/lin_15_30_na_0.01.json