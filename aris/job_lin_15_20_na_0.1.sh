...
#SBATCH --job-name=lin15-20-na-0.1    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/lin15-20-na-0.1.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/lin15-20-na-0.1.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
-e configs/experiment/aris/lin_15_20_na_0.1.json