...
#SBATCH --job-name=drop3-small    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/drop3-small.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/drop3-small.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
-e configs/experiment/aris/drop3_cifar10.json