...
#SBATCH --job-name=lin20-35    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/lin20-35.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/lin20-35.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
-e configs/experiment/aris/lin_20_35.json