...
#SBATCH --job-name=mul-s-10-smp-0.5    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/mul-s-10-smp-0.5.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/mul-s-10-smp-0.5.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
-e configs/experiment/aris/mul_10_smp_0.5.json