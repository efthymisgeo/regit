...
#SBATCH --job-name=lin5-7    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/lin5-7.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/lin5-7.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
-e configs/experiment/aris/lin_5_7.json