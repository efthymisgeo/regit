...
#SBATCH --job-name=lin0-20    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/lin0-20.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/lin0-20.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
-e configs/experiment/aris/lin_0_20.json