...
#SBATCH --job-name=lin5-12    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=logs/lin5-12.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=logs/lin5-12.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
...
-e configs/experiment/aris/lin_5_12.json